                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-4">
                    <div className="space-y-1">
                        ...
                        <div className="relative">
                            ...
                            <input required type="text" className="w-full bg-zinc-50 border border-zinc-200 rounded-xl py-3 pl-12 font-bold text-zinc-900 outline-none focus:border-black transition-colors"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                ...
                                <select className="w-full bg-zinc-50 border border-zinc-200 rounded-xl py-3 pl-12 font-bold appearance-none text-zinc-900 outline-none focus:border-black transition-colors"
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="relative">
                            ...
                            <input required type="tel" className="w-full bg-zinc-50 border border-zinc-200 rounded-xl py-3 pl-12 font-bold text-zinc-900 outline-none focus:border-black transition-colors"
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="relative">
                            ...
                            <input type="email" className="w-full bg-zinc-50 border border-zinc-200 rounded-xl py-3 pl-12 font-bold text-zinc-900 outline-none focus:border-black transition-colors"
